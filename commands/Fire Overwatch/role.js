...
function collectionFindNoCase(roles, string) {
  return roles.find((item) => {
    console.log(`In find role in collection no case : item.name.toLowerCase() = ${item.name.toLowerCase()} / string.toLowerCase() = ${string.toLowerCase()}`);
    console.log(`Value returned to collection.find : ${item.name.toLowerCase() === string.toLowerCase()}`);
